...
| `RLSECURE_BEARER_TOKEN`   | No | instead of using the --bearer-token you can set this env var. |
| `RLSECURE_AUTH_USER`      | No | instead of using the --auth-user you can use this env var. |
| `RLSECURE_AUTH_PASS`      | No | instead of using the --auth-pass you can use this env var. |
